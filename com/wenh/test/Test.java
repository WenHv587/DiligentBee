        ...
        all:while (true) {
            ...
            switch (choice) {
                ...
                case "2":
                    ...
                    while (true) {
                        System.out.println("请输入您查询的查询条件(输入back返回主页面):");
                    ...
                    if (!AnimalDaoImpl.checkName(names)) { // 如果用户输入的属性名称任何一个动物都没有
                ...
                case "3":
                    ...
                    while (true) {
                        ...
                        if (species.equalsIgnoreCase("back")) {
                            continue all;
                        }
                        break;
                    }
                    ...
                    do {
                        ...
                        if (s.equalsIgnoreCase("y")) {
                            ...
                            String s2 = scanner.nextLine(); // 属性值没有做非空校验，因为我认为扩展的属性值应该被允许为空
                            animalMap.put(s1, s2);
                        } else if (s.equalsIgnoreCase("n")) {
                            if (!AnimalDaoImpl.checkRepeat(animal)) {
                ...
                case "4":
                     ...
                     */
                    if (!AnimalDaoImpl.ifNull()) {
                        System.out.println("还没有添加任何动物信息!");
                        System.out.println();
                        continue;
                    }
                    ad.select();
                    ...
                    b:switch (num) {
                        case "1":
                            ...
                            a:while (true) {
                                ...
                                if (!AnimalDaoImpl.checkExist(aid1,name)) { // 如果用户输入的属性名不存在
                                    ...
                                    while (true) {
                                        ...
                                        if ((name.equals("种类") || name.equals("性别")) && !CheckUtils.checkProperty(property)) {
                        ...
                        case "2":
                            ...
                            while (true) {
                                ...
                                if (!AnimalDaoImpl.checkID(aid2)) {
                                    System.out.println("你所输入的id并不存在，请检查后重新输入!");
                                    continue;
                                } else if (!AnimalDaoImpl.checkMap(aid2)) {
                            ...
                            out:while (true) {
                                ...
                                String name = scanner.nextLine();
                                if (name.equals("种类") || name.equals("年龄") || name.equals("性别") || name.equalsIgnoreCase("id")) {
                                ...
                                if (!AnimalDaoImpl.checkExist(aid2, name)) {
